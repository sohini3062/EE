...
const Login_THV = () => {
  ...
  if (isLoggedIn) {
    return <Navigate to="/dashboard_THV" replace />;
  }
  return (
            ...
            <Box sx={{ mt: 3 }}>
              <Formik
                ...
                validationSchema={Yup.object({
                  ...
                  password: Yup.string()
                    .min(4, "Password is minimum 8 characters in length.")
                    .required("This field is required!"),
                })}
              ...
              <Grid container>
                <Grid item xs={12} style={{ textAlign: "center" }}>
                  <Link to="/register_THV" style={{ textDecoration: "none" }}>
